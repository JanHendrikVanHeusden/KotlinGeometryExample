...
internal class ParallelogramTest {
    ...
    @Test
    fun getAngleRadians() {
        val parallelogram1 = Parallelogram(s1 = 10.0, s2 = 15.0, angleDegrees = 45.0)
        assertThat(parallelogram1.angleRadians).isCloseTo(Math.PI/4.0, offset(0.00001))

        val parallelogram2 = Parallelogram(s1 = 4.3564, s2 = 125.68, angleDegrees = 30.0)
    ...
    fun getLength() {
        var s1 = 10.0
        var s2 = 15.0
        val parallelogram1 = Parallelogram(s1, s2, angleDegrees = 76.4)
        assertThat(parallelogram1.length).isEqualTo(s1) // s1 is synonym for length

        s1 = 22.458
        s2 = 314543.12
        val parallelogram2 = Parallelogram(s1, s2, angleDegrees = 66.832)
    ...
    fun testEquals() {
        // given
        val parallelogram1 = Parallelogram(s1 = 10.0, s2 = 15.0, angleDegrees = 25.0)
        val parallelogram2 = Parallelogram(s1 = 10.0, s2 = 15.0, angleDegrees = 25.0)
        // check equality
